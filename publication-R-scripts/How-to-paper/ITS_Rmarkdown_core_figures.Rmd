...
rm(alpha.object)
```
```{R Alpha diversity Suppl A, warning=FALSE, message=FALSE}
...
```{R Alpha diversity Suppl B, warning=FALSE, message=FALSE}
########## alpha diversity (InvSimpson)
...
```{R Alpha diversity Suppl C, warning=FALSE, message=FALSE}
...
# Open a new PDF graphics device
# pdf(file = "Fig11_ITS.pdf", width=11,height=7.5)
# Print the figure
print(fig)
