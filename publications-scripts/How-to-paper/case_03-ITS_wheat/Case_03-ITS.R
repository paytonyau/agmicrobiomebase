### ITS taxonomy and Fusarium in wheat
## Author : Payton Yau
## Date : 12-03-2024

# Rhizosphere fungi, including soil-borne pathogens, impact plant health and crop yields. 
# In our study, we analyzed Fusarium ASVs from wheat rhizospheres across different soils. 
# Fusarium species, known for causing ear blight in cereals, can lead to mycotoxin contamination, affecting human health.
