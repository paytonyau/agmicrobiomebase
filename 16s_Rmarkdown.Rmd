...
pcoa <- ordinate(physeq = physeq.ori, method = "NMDS", distance = "bray")
...
#### Based on Plate and Type
# method options: NMDS / PCoA
pcoa <- ordinate(physeq = physeq.norm, method = "NMDS", distance = "bray")
...
##  
Top30ASVs = names(sort(taxa_sums(proportions), TRUE)[1:65])
