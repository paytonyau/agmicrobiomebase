...
```{r Alpha_3, warning=FALSE, message=FALSE}
# Plot ordination
# pdf(file = "bata_norm_plate.pdf", width = 9,height = 8)
plot_ordination(physeq = physeq.norm,
  ...
  scale_shape_manual(values = c(15, 17, 25, 11, 16, 18, 21, 22, 23),
                     guide = guide_legend(ncol = 2)) # Set custom shapes

```

#### colour the crop types
```{r Alpha_4, warning=FALSE, message=FALSE}
plot_ordination(physeq = physeq.norm,
                ordination = NMDS2,
                color = "Soil",
                shape = "Type"
...
```{r Alpha_5, warning=FALSE, message=FALSE}
