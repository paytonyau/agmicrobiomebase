...
```{r Install_PERMANOVA, warning=FALSE, message=FALSE}
...
```{Num, warning=FALSE, message=FALSE}
...
p <- ggtree(GP.chl, ladderize = FALSE) +
  ...
  theme(text = element_text(size=15, colour = "black"), 
        ...
        axis.title.y = element_text(color="black", size=2.5,face="bold"), legend.osition = "top")
